...
export class InMemoryDataService implements InMemoryDbService {
    ...
    createDb() {
        ...
        return {daemons, daemon, configs, config, upgrade, service, userCreate, bookSearch, getHistory, book, getBookmark, newBookmark};
    }
    ...
    getRootPath(url: string): string {
        ...
        debugger;
        let collectionNames = ['daemons', 'daemon', 'configs', 'config', 'upgrade', 'service', 'userCreate', 'book'];
